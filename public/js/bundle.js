...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFobWFuYnVqYW5nZ2EiLCJhIjoiY2tjZWp4YWZzMDkzejJycGJjdjRoY3N4dSJ9.yd59mBrwUWBMYq3bJGld5Q';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " ").concat(loc.description, "</p>")).addTo(map); //extends map bounds to include current tour location
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"upadateSettings.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/update-mypassword' : 'http://127.0.0.1:3000/api/v1/users/update-me';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " has been updated succesfully !"));
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51H4TJWCiJVbrCxa6l237OvdRAzeZSTNzmdtGAnvK5kNgfvwpxv2CW3DeSLtTYs9aa7F0vgv2wJPckKfTrErSzYP900mMUUaqpK');
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    ...
    (0, _upadateSettings.updateData)('data', form);
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _upadateSettings.updateData)('password', {
